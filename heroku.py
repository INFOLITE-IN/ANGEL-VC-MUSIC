#
# Copyright (C) 2021-2022 by social-mechanic-1997, < https://github.com/SOCIAL-MECHANIC-1997>.
#
# This file is part of <https://github.com/SOCIAL-MECHANIC-1997/ANGEL-VC-MUSIC> project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/SOCIAL-MECHANIC-1997/ANGEL-VC-MUSIC/blob/master/LICENSE >
#
# All rights reserved.
...
from ANGEL import app
from ANGEL.misc import HAPP, SUDOERS, XCB
from ANGEL.utils.database import (get_active_chats,
                                       remove_active_chat,
                                       remove_active_video_chat)
from ANGEL.utils.decorators.language import language
from ANGEL.utils.pastebin import ANGELbin
...
@app.on_message(filters.command(GETVAR_COMMAND) & SUDOUSERS)
@language
...
@app.on_message(filters.command(DELVAR_COMMAND) & SUDOUSERS)
@language
...
@app.on_message(filters.command(SETVAR_COMMAND) & SUDOUSERS)
@language
...
@app.on_message(filters.command(USAGE_COMMAND) & SUDOUSERS)
@language
...
@app.on_message(filters.command(REBOOT_COMMAND) & SUDOUSERS)
